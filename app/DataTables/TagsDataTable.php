...
class TagsDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('edit', 'dashboard.tags.btns.edit')
            ->addColumn('delete', 'dashboard.tags.btns.delete')
            ->addColumn('checkbox', 'dashboard.tags.btns.checkbox')
            ->rawColumns([
    ...
    {
        return $this->builder()
            ->setTableId('tagsdatatable-table')
