...
<div class="col-lg-12 col-md-12">
    <div class="single_jobs white-bg d-flex justify-content-between">
        ...
        <div class="jobs_right">
            <div class="apply_now">
                @role('seeker')
                <a class="heart_mark {{ auth()->user()->hasSavedJob($job) ? 'bg-green' : ''  }}"
                    data-url="{{ route('jobs.show',$job->slug) }}" href="{{ route('jobs.save',$job->slug) }}"> <i
                        class="fa fa-heart"></i> </a>
                <a data-url="{{ route('jobs.apply',$job->slug) }}" href="{{ route('jobs.apply',$job->slug) }}"
