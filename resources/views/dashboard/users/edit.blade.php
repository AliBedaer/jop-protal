            ...
            <div class="tile-body">
              ...
              {!! Form::open(['route' => ['dashboard.users.update',$user->id],'files' => true]) !!}
                ...
                @if ( $user->hasSeekerProfile )
                   ...
                   <div class="form-group">
                     <a download href="{{ Storage::url($user->profile->cv) }}" target="_blank" class="btn btn-primary btn-lg text-white">
                ...
                <div class="tile-footer">
                    ...
                    <a class="btn btn-secondary" href="{{ route('dashboard.users.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>{{ trans('dashboard.cancel') }}</a>
               </div>
