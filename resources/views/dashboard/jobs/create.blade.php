              ...
              {!! Form::open(['route' => 'dashboard.jobs.store','files' => true]) !!}
                ...
                <div class="form-group">
                  {!! Form::label(trans('dashboard.tags')) !!}
                   <select name="tags[]" style="width:100%; height: 100%;" class="form-control select2-hidden-accessible" id="tagsSelect2" multiple tabindex="-1" aria-hidden="true">
                 ...
                 <div class="form-group">
                  {!! Form::label(trans('dashboard.skills')) !!}
                   <select name="skills[]" style="width:100%; height: 100%;" class="form-control select2-hidden-accessible" id="skillsSelect2" multiple tabindex="-1" aria-hidden="true">
                ...
                <div class="tile-footer">
                    <button class="btn btn-primary" name="action" value="save" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>{{ trans('dashboard.save') }}</button>&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-primary" name="action" value="save-add" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save&Add Another</button>&nbsp;&nbsp;&nbsp;
                    <button class="btn btn-primary" name="action" value="save-edit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Save&Editing</button>&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-secondary" href="{{ route('dashboard.jobs.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancel</a>
               </div>
