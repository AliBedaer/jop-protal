            ...
            <div class="tile-body">
              ...
              {!! Form::open(['route' => ['dashboard.comments.update',$comment->id]]) !!}
                ...
                <div class="tile-footer">
                    <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>{{ trans('dashboard.save') }}</button>&nbsp;&nbsp;&nbsp;
                    <a class="btn btn-secondary" href="{{ route('dashboard.comments.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>{{ trans('dashboard.cancel') }}</a>
               </div>
