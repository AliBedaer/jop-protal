          ...
          <div class="tile">
            <section class="invoice">
                ...
                <div class="col-12 table-responsive">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <tr>
                        <td>{{ $contact->id }}</td>
                        <td style="width: 50%"><p>{{ $contact->message }}</p></td>
                        <td>
                          {!! Form::open(['route' => ['dashboard.contacts.reply',$contact->id] ]) !!}

                          {!! Form::textarea('reply',old('reply'),['class' => 'form-control','placeholder' => 'Type you reply']) !!}
              ...
              <div class="row d-print-none mt-2 text-white">
                <div class="col-12 text-right"><button type="submit" class="btn btn-primary"><i class="fa fa-reply"></i> Reply</button></div>
                {!! Form::close() !!}
              </div>
            </section>
          </div>
